...
* [#1292](https://github.com/phanviet/prelude/issues/1292): Add `prelude-python-mode-set-encoding-automatically` defcustom inn `prelude-python.el` module with nil default value.
* [#1278](https://github.com/phanviet/prelude/issues/1278): Don't disable `menu-bar-mode` unless `prelude-minimalistic-ui` is enabled.
* [#1277](https://github.com/phanviet/prelude/issues/1277): Make it possible to disable the creation of `Super`-based keybindings via `prelude-super-keybindings`.
...
* [#1302](https://github.com/phanviet/prelude/issues/1302): C-a should be bound to org-beginning-of-line in org-mode buffers
